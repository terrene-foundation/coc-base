...
Native subagent spawning is unreliable in headless mode. Use pattern (a): inline-cat `.codex/prompts/specialist-stack-detector.md` into the turn, then provide your task in the same session.
