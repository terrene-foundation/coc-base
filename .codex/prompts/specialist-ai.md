...
After invoking `/prompts:specialist-ai`, your context now contains the operating specification below. Read the user's task and respond as the ai specialist.
...
Native subagent spawning is unreliable in headless mode. Use pattern (a): invoke `/prompts:specialist-ai`, then provide your task in the same session.
