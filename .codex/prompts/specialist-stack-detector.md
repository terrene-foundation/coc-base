...
After invoking `/prompts:specialist-stack-detector`, your context now contains the operating specification below. Read the user's task and respond as the stack-detector specialist.
...
Native subagent spawning is unreliable in headless mode. Use pattern (a): invoke `/prompts:specialist-stack-detector`, then provide your task in the same session.
